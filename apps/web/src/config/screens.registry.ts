...
export const SCREEN_REGISTRY: ScreenDef[] = [
  ...
  { route: '/hr/leaves',             module: 'people', label: 'Quản lý đơn nghỉ phép',      icon: 'CalendarOutlined',      permCode: 'leaves:approve',               sortOrder: 26 },
  ...
  { route: '/assets/room-booking',   module: 'work',  label: 'Đặt phòng họp',    icon: 'CalendarOutlined', permCode: 'room_booking:read',      sortOrder: 4 },
  { route: '/assets/vehicles',       module: 'work',  label: 'Đặt xe công ty',   icon: 'CarOutlined',      permCode: 'vehicles:read',          sortOrder: 5 },
