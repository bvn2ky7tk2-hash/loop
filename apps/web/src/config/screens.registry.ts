...
export const SCREEN_REGISTRY: ScreenDef[] = [
  ...
  // ─── Work — Công việc ──────────────────────────────────────────────────────
  { route: '/my-tasks',            module: 'work', label: 'Bảng công việc',     icon: 'AppstoreOutlined',    permCode: 'kanban:read',              sortOrder: 1 },
  ...
  { route: '/knowledge-base',      module: 'work', label: 'Cơ sở tri thức',     icon: 'BookOutlined',        permCode: 'knowledge_base:read',      sortOrder: 8 },
  { route: '/timesheet',           module: 'work', label: 'Chấm công của tôi',  icon: 'ClockCircleOutlined', permCode: 'timesheets:read',          sortOrder: 9 },
  { route: '/timesheet/project',   module: 'work', label: 'Nhật ký dự án',      icon: 'LineChartOutlined',   permCode: 'timesheet_project:read',   sortOrder: 10 },
  ...
  { route: '/self-service',        module: 'work', label: 'Thông tin của tôi',  icon: 'UserOutlined',        permCode: 'self_service:read',        sortOrder: 15 },
  { route: '/payroll/my-payslips', module: 'work', label: 'Phiếu lương',         icon: 'FileTextOutlined',    permCode: 'my_payslips:read',         sortOrder: 16 },
  ...
  { route: '/leaves',              module: 'people', label: 'Đơn nghỉ phép',         icon: 'CalendarOutlined',      permCode: 'leaves:read',                 sortOrder: 4 },
  { route: '/payroll',             module: 'people', label: 'Bảng lương',            icon: 'CreditCardOutlined',    permCode: 'payroll:read',                sortOrder: 5 },
  { route: '/payroll/settings',    module: 'people', label: 'Cài đặt lương',         icon: 'SettingOutlined',       permCode: 'payroll_settings:manage',     sortOrder: 6 },
  { route: '/hr/training',         module: 'people', label: 'Đào tạo',               icon: 'ReadOutlined',          permCode: 'training:read',               sortOrder: 7 },
  { route: '/hr/performance',      module: 'people', label: 'Đánh giá năng lực',     icon: 'TrophyOutlined',        permCode: 'performance:read',            sortOrder: 8 },
  { route: '/hr/skill-matrix',     module: 'people', label: 'Ma trận kỹ năng',       icon: 'ApartmentOutlined',     permCode: 'skills:read',                 sortOrder: 9 },
  { route: '/hr/okr',              module: 'people', label: 'OKR & KPI',              icon: 'AimOutlined',           permCode: 'okr:read',                    sortOrder: 10 },
  { route: '/recruit/pipeline',    module: 'people', label: 'Phễu tuyển dụng',       icon: 'AppstoreAddOutlined',   permCode: 'recruit_pipeline:read',       sortOrder: 11 },
  { route: '/recruit/candidates',  module: 'people', label: 'Ứng viên',               icon: 'UsergroupAddOutlined',  permCode: 'recruit_candidates:read',     sortOrder: 12 },
  { route: '/recruit/interviews',  module: 'people', label: 'Lịch phỏng vấn',         icon: 'ScheduleFilled',        permCode: 'recruit_interviews:read',     sortOrder: 13 },
  { route: '/recruit/jobs',        module: 'people', label: 'Vị trí tuyển dụng',      icon: 'SolutionOutlined',      permCode: 'recruit_jobs:read',           sortOrder: 14 },
  { route: '/timesheet/approvals',   module: 'people', label: 'Duyệt chấm công',        icon: 'AuditOutlined',         permCode: 'timesheet_approvals:approve', sortOrder: 15 },
  { route: '/timesheet/manager',     module: 'people', label: 'Bảng điểm danh',         icon: 'LineChartOutlined',     permCode: 'timesheet_manager:read',      sortOrder: 16 },
  // HR v4.0
  { route: '/hr/job-titles',         module: 'people', label: 'Chức danh',               icon: 'TagOutlined',           permCode: 'employees:read',              sortOrder: 17 },
  { route: '/hr/positions',          module: 'people', label: 'Vị trí biên chế',         icon: 'ApartmentOutlined',     permCode: 'employees:read',              sortOrder: 18 },
  { route: '/hr/decisions',          module: 'people', label: 'Quyết định nhân sự',      icon: 'FileProtectOutlined',   permCode: 'hr_decisions:read',           sortOrder: 19 },
  { route: '/hr/insurance',          module: 'people', label: 'Bảo hiểm xã hội',         icon: 'SafetyOutlined',        permCode: 'insurance:read',              sortOrder: 20 },
  { route: '/hr/leave-policies',     module: 'people', label: 'Chính sách phép năm',     icon: 'CalendarOutlined',      permCode: 'leave_policy:read',           sortOrder: 21 },
  { route: '/hr/attendance',         module: 'people', label: 'Bảng công',               icon: 'ScheduleOutlined',      permCode: 'attendance:read',             sortOrder: 22 },
  { route: '/hr/holidays',           module: 'people', label: 'Ngày lễ',                  icon: 'StarOutlined',          permCode: 'holidays:read',               sortOrder: 23 },
  ...
  { route: '/budget',                        module: 'finance', label: 'Ngân sách',           icon: 'PieChartOutlined',   permCode: 'budget:read',             sortOrder: 2 },
  { route: '/expenses',                      module: 'finance', label: 'Đề nghị thanh toán', icon: 'WalletOutlined',     permCode: 'expenses:read',           sortOrder: 3 },
  { route: '/invoices',                      module: 'finance', label: 'Hoá đơn',             icon: 'FileTextOutlined',   permCode: 'invoices:read',           sortOrder: 4 },
  { route: '/accounting/accounts',           module: 'finance', label: 'Hệ thống tài khoản',  icon: 'BankOutlined',       permCode: 'accounts:read',           sortOrder: 5 },
  { route: '/accounting/journal',            module: 'finance', label: 'Nhật ký kế toán',     icon: 'BookOutlined',       permCode: 'journal:read',            sortOrder: 6 },
  { route: '/accounting/financial-reports',  module: 'finance', label: 'Báo cáo tài chính',   icon: 'FundOutlined',       permCode: 'financial_reports:read',  sortOrder: 7 },
  ...
  { route: '/assets/room-booking',   module: 'asset', label: 'Đặt phòng họp',    icon: 'CalendarOutlined', permCode: 'room_booking:read',      sortOrder: 4 },
  { route: '/assets/vehicles',       module: 'asset', label: 'Đặt xe công ty',   icon: 'CarOutlined',      permCode: 'vehicles:read',          sortOrder: 5 },
  { route: '/procurement/vendors',   module: 'asset', label: 'Nhà cung cấp',     icon: 'ShopOutlined',     permCode: 'vendors:read',           sortOrder: 6 },
  { route: '/procurement/orders',    module: 'asset', label: 'Đơn mua hàng',     icon: 'FileTextOutlined', permCode: 'purchase_orders:read',   sortOrder: 7 },
  ...
  { route: '/import',              module: 'admin', label: 'Nhập dữ liệu',       icon: 'UploadOutlined',            permCode: 'data_import:manage',     sortOrder: 6 },
  { route: '/audit-log',           module: 'admin', label: 'Nhật ký hệ thống',   icon: 'AuditOutlined',             permCode: 'audit_log:read',         sortOrder: 7 },
  { route: '/automation',          module: 'admin', label: 'Tự động hóa',        icon: 'ThunderboltOutlined',       permCode: 'automation:read',        sortOrder: 8 },
  { route: '/scheduled-reports',   module: 'admin', label: 'Báo cáo định kỳ',    icon: 'MailOutlined',              permCode: 'scheduled_reports:read', sortOrder: 9 },
  { route: '/module-config',       module: 'admin', label: 'Cấu hình phân hệ',    icon: 'AppstoreOutlined',          permCode: 'module_config:manage',   sortOrder: 10 },
  { route: '/admin/health',        module: 'admin', label: 'Giám sát hệ thống',   icon: 'MonitorOutlined',           permCode: 'system_health:read',     sortOrder: 11 },
  { route: '/admin/demo',          module: 'admin', label: 'Chế độ trình diễn',   icon: 'ExperimentOutlined',        permCode: 'demo_mode:manage',       sortOrder: 12 },
  { route: '/onboarding',          module: 'admin', label: 'Hướng dẫn khởi động', icon: 'RocketOutlined',            permCode: 'onboarding:manage',      sortOrder: 13 },
  { route: '/settings/tenant',     module: 'admin', label: 'Cài đặt Công ty',     icon: 'BuildOutlined',             permCode: 'admin:users',            sortOrder: 14 },
];
