        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ width: '100%', maxWidth: 380 }}>
              ...
              <Divider style={{ color: textSecondary, borderColor, fontSize: 12, margin: '20px 0' }}>
                hoặc
              </Divider>
              ...
              <Button
                ...
                style={{
                  height: 48, fontSize: 14, fontWeight: 500, borderRadius: 10,
                  border: `1px solid ${borderColor}`,
              ...
              <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: textSecondary }}>
                Chưa có tài khoản?{' '}
                <a style={{ color: linkColor, fontWeight: 600 }}>Đăng ký ngay</a>
              </div>
            </div>
          </div>
