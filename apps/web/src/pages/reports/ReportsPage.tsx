...
import { DownloadOutlined, ClockCircleOutlined, CheckCircleOutlined, BugOutlined, TeamOutlined, ShopOutlined, UsergroupAddOutlined, LaptopOutlined, SwapOutlined } from '@ant-design/icons';
...
function PeriodComparisonTab({ chartCardStyle }: { chartCardStyle: React.CSSProperties }) {
